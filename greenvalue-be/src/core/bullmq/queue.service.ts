...
/**
 * BullMQ Queue Service for GreenValue AI Platform
 * 
 * Queue types:
 * - analysis: Image analysis, building detection jobs
...
export class QueueService implements OnModuleInit, OnModuleDestroy {
    ...
    async addAnalysisJob(data: {
        type: 'image-analysis' | 'u-value' | 'similarity';
        jobId: string;
        userId: string;
        propertyId: string;
        payload: any;
    }) {
        return this.addJob(QueueService.QUEUES.ANALYSIS, data.type, data, {
    ...
    async addReportJob(data: {
        ...
        return this.addJob(QueueService.QUEUES.REPORTS, 'generate-report', data);
    }
    ...
    async addEmailJob(data: {
        ...
        return this.addJob(QueueService.QUEUES.EMAIL, 'send-email', data);
    }
