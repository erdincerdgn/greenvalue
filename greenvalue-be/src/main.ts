...
async function bootstrap() {
    ...
    if (!isProduction || process.env.ENABLE_SWAGGER === 'true') {
        const config = new DocumentBuilder()
            .setTitle('GreenValue AI API')
            .setDescription(`
        **GreenValue AI — Property Valuation & Energy Retrofit Intelligence**
        
        AI-powered PropTech platform with:
        - YOLO11 Building Component Detection
        - U-Value & Energy Label Calculation (EN ISO 6946)
      ...
      `)
            .setVersion('1.0.0')
            .setContact('GreenValue AI Team', 'https://greenvalue.ai', 'support@greenvalue.ai')
            ...
            .addTag('Analysis', 'AI image analysis & energy labels')
        ...
        SwaggerModule.setup('docs', app, document, {
            ...
            customSiteTitle: 'GreenValue AI API Docs',
        });
    ...
    logger.log(`🚀 GreenValue API running on: ${await app.getUrl()}`);
